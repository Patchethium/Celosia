pub const ATTN_DIM: u32 = 128;
pub const ALPHABET_DIM: u32 = 30;
pub const PHONEME_DIM: u32 = 74;

pub const PADDING: [&'static str; 3] = ["<pad>", "<sos>", "<eos>"];

pub const AMEPD_PHONE_SET: [&'static str; 74] = [ "<pad>", "<sos>", "<eos>",
...
pub const ALPHABETS: [char; 26] = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];
