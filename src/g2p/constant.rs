...
pub(crate) static N_ENC_LAYER: usize = 2;
pub(crate) static N_DEC_LAYER: usize = 2;
pub(crate) static N_HEAD: usize = 4;

pub(crate) static SPECIAL_TOKENS: [&str; 3] = ["<pad>", "<sos>", "<eos>"];
pub(crate) static SPECIAL_LEN: usize = SPECIAL_TOKENS.len();

pub(crate) static PAD_IDX: usize = 0;
pub static SOS_IDX: usize = 1;
pub static EOS_IDX: usize = 2;

pub(crate) static MAX_LEN: usize = 32;

pub(crate) static EN_ALPHABET: [char; 27] = [
  'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's',
  't', 'u', 'v', 'w', 'x', 'y', 'z', '\'',
];

pub(crate) static EN_PHONEME: [&str; 71] = [
...
pub(crate) static D_EN_ALPHABET: usize = SPECIAL_TOKENS.len() + EN_ALPHABET.len();
pub(crate) static D_EN_PHONEME: usize = SPECIAL_TOKENS.len() + EN_PHONEME.len();

pub(crate) static FR_ALPHABET: [char; 45] = [
  '\'', '-', '.', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p',
  'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'à', 'â', 'ã', 'ç', 'è', 'é', 'ê', 'ë', 'î',
  'ï', 'ñ', 'ô', 'ö', 'ù', 'û', 'ü',
];

pub(crate) static FR_PHONEME: [&str; 31] = [
  "@", "^", "a", "b", "cinq", "d", "deux", "e", "f", "g", "huit", "i", "j", "k", "l", "m", "n",
  "neuf", "o", "p", "r", "s", "t", "to", "u", "un", "v", "w", "x", "y", "z",
];

pub(crate) static D_FR_ALPHABET: usize = SPECIAL_TOKENS.len() + FR_ALPHABET.len();
pub(crate) static D_FR_PHONEME: usize = SPECIAL_TOKENS.len() + FR_PHONEME.len();

pub(crate) static DE_ALPHABET: [char; 30] = [
  '#', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r',
  's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'ä', 'ö', 'ü',
];

pub(crate) static DE_PHONEME: [&str; 68] = [
...
pub(crate) static D_DE_ALPHABET: usize = SPECIAL_TOKENS.len() + DE_ALPHABET.len();
pub(crate) static D_DE_PHONEME: usize = SPECIAL_TOKENS.len() + DE_PHONEME.len();
